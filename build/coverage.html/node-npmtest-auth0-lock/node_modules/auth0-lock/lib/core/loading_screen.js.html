...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/loading_screen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/loading_screen.js</span></h1>
    <h2>
        
        Statements: <span class="metric">58.93% <small>(33 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">41.94% <small>(13 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/</a> &#187; loading_screen.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LoadingScreen() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LoadingScreen);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, _Screen.call(this, "loading"));</span>
  }
&nbsp;
  LoadingScreen.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    return LoadingPane;</span>
  };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LoadingPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LoadingPane);</span>
&nbsp;
...
&nbsp;
  LoadingPane.prototype.componentDidMount = <span class="fstat-no" title="function not covered" >function componentDidMount() {</span>
<span class="cstat-no" title="statement not covered" >    var model = this.props.model;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _actions.pinLoadingPane)(l.id(model));</span>
...
<span class="cstat-no" title="statement not covered" >      return (0, _actions.unpinLoadingPane)(l.id(model));</span>
    }, 500);
  };
&nbsp;
  LoadingPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
