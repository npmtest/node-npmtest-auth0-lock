...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/mfa-code/mfa_code_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/mfa-code/mfa_code_pane.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62% <small>(31 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/mfa-code/</a> &#187; mfa_code_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function MFACodePane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, MFACodePane);</span>
&nbsp;
...
&nbsp;
  MFACodePane.prototype.handleChange = <span class="fstat-no" title="function not covered" >function handleChange(e) {</span>
<span class="cstat-no" title="statement not covered" >    var lock = this.props.lock;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _index2.swap)(_index2.updateEntity, "lock", l.id(lock), _mfa_code.setMFACode, e.target.value);</span>
  };
&nbsp;
  MFACodePane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(_mfa_code_input2.default, {</span>
