...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/phone-number/phone_number_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/phone-number/phone_number_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/phone-number/</a> &#187; phone_number_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PhoneNumberPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PhoneNumberPane);</span>
&nbsp;
...
&nbsp;
  PhoneNumberPane.prototype.handlePhoneNumberChange = <span class="fstat-no" title="function not covered" >function handlePhoneNumberChange(e) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _index3.swap)(_index3.updateEntity, "lock", l.id(this.props.lock), _phone_number.setPhoneNumber, e.target.value);</span>
  };
&nbsp;
  PhoneNumberPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
<span class="cstat-no" title="statement not covered" >          return (0, _actions.startOptionSelection)(l.id(lock), "location", "", icon);</span>
        }
      }),
