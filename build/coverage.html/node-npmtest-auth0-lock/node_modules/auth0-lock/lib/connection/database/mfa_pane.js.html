...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/mfa_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/mfa_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/</a> &#187; mfa_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function MFAPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, MFAPane);</span>
&nbsp;
...
&nbsp;
  MFAPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var pane = _react2.default.createElement(_mfa_code_pane2.default, {</span>
      i18n: i18n,
      lock: lock,
      placeholder: mfaInputPlaceholder
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var titleElement = title &amp;&amp; _react2.default.createElement(</span>
      'h2',
      null,
      title
    );
