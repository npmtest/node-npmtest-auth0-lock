...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/password_reset_confirmation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/password_reset_confirmation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/</a> &#187; password_reset_confirmation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PasswordResetConfirmation() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PasswordResetConfirmation);</span>
&nbsp;
...
&nbsp;
  PasswordResetConfirmation.prototype.handleClose = <span class="fstat-no" title="function not covered" >function handleClose() {</span>
<span class="cstat-no" title="statement not covered" >    var _props = this.props,</span>
        closeHandler = _props.closeHandler,
        lock = _props.lock;
&nbsp;
<span class="cstat-no" title="statement not covered" >    closeHandler(l.id(lock));</span>
  };
&nbsp;
  PasswordResetConfirmation.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    var lock = this.props.lock;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var closeHandler = l.ui.closable(lock) ? this.handleClose.bind(this) : undefined;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function renderPasswordResetConfirmation(m) {</span>
<span class="cstat-no" title="statement not covered" >  var props = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  props.closeHandler = _actions.closeLock;</span>
<span class="cstat-no" title="statement not covered" >  props.key = "auxiliarypane";</span>
<span class="cstat-no" title="statement not covered" >  props.lock = m;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return m.get("passwordResetted") ? _react2.default.createElement(PasswordResetConfirmation, props) : null;</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
