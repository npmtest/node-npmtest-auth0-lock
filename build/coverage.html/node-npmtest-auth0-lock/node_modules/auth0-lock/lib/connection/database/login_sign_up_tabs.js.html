...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/login_sign_up_tabs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/login_sign_up_tabs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/</a> &#187; login_sign_up_tabs.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LoginSignUpTabs() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LoginSignUpTabs);</span>
&nbsp;
...
&nbsp;
  LoginSignUpTabs.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var isLogin = (0, _index2.getScreen)(lock) === "login";</span>
&nbsp;
...
&nbsp;
  LoginSignUpTabs.prototype.handleLoginClick = <span class="fstat-no" title="function not covered" >function handleLoginClick() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _actions.showLoginActivity)(l.id(this.props.lock));</span>
  };
&nbsp;
  LoginSignUpTabs.prototype.handleSignUpClick = <span class="fstat-no" title="function not covered" >function handleSignUpClick() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.props.signUpLink) {</span>
<span class="cstat-no" title="statement not covered" >      (0, _actions2.closeLock)(l.id(this.props.lock), true);</span>
    }
<span class="cstat-no" title="statement not covered" >    (0, _actions.showSignUpActivity)(l.id(this.props.lock));</span>
  };
&nbsp;
  LoginSignUpTabs.prototype.handleSignUpWithHrefClick = <span class="fstat-no" title="function not covered" >function handleSignUpWithHrefClick() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _actions2.closeLock)(l.id(this.props.lock), true);</span>
  };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LoginSignUpTab() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LoginSignUpTab);</span>
&nbsp;
...
&nbsp;
  LoginSignUpTab.prototype.handleClick = <span class="fstat-no" title="function not covered" >function handleClick(e) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.props.href) {</span>
<span class="cstat-no" title="statement not covered" >      this.props.clickWithHrefHandler();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >      this.props.clickHandler();</span>
    }
  };
&nbsp;
  LoginSignUpTab.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    var _props2 = this.props,</span>
        current = _props2.current,
        href = _props2.href,
        label = _props2.label;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var className = current ? "auth0-lock-tabs-current" : "";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(</span>
      'li',
      { className: className },
