...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/signed_up_confirmation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/signed_up_confirmation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/</a> &#187; signed_up_confirmation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SignedUpConfirmation() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SignedUpConfirmation);</span>
&nbsp;
...
&nbsp;
  SignedUpConfirmation.prototype.handleClose = <span class="fstat-no" title="function not covered" >function handleClose() {</span>
...
&nbsp;
  SignedUpConfirmation.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function renderSignedUpConfirmation(m) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return m.get("signedUp") &amp;&amp; !(0, _index2.shouldAutoLogin)(m) ? _react2.default.createElement(SignedUpConfirmation, props) : null;</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
