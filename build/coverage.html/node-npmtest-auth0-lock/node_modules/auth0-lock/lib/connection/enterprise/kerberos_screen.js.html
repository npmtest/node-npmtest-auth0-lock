...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/enterprise/kerberos_screen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/enterprise/kerberos_screen.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/enterprise/</a> &#187; kerberos_screen.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var i18n = _ref.i18n,</span>
      model = _ref.model;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var headerText = i18n.html("windowsAuthInstructions") || null;</span>
...
<span class="cstat-no" title="statement not covered" >      return (0, _actions.skipQuickAuth)(l.id(model));</span>
    ...
    buttonClickHandler: <span class="fstat-no" title="function not covered" >function buttonClickHandler(e) {</span>
<span class="cstat-no" title="statement not covered" >      return (0, _actions.logIn)(l.id(model), (0, _enterprise.corpNetworkConnection)(model));</span>
    },
    header: header,
    strategy: 'windows'
  });
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function KerberosScreen() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, KerberosScreen);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, _Screen.call(this, "kerberos"));</span>
  }
&nbsp;
  KerberosScreen.prototype.renderAuxiliaryPane = <span class="fstat-no" title="function not covered" >function renderAuxiliaryPane(lock) {</span>
<span class="cstat-no" title="statement not covered" >    return (0, _signed_in_confirmation.renderSignedInConfirmation)(lock);</span>
  };
&nbsp;
  KerberosScreen.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
