...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/classic/sign_up_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/classic/sign_up_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/classic/</a> &#187; sign_up_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SignUpPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SignUpPane);</span>
&nbsp;
...
&nbsp;
  SignUpPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var usernamePane = !onlyEmail &amp;&amp; (0, _index.databaseConnectionRequiresUsername)(model) ? _react2.default.createElement(_username_pane2.default, {</span>
      i18n: i18n,
      lock: model,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var fields = !onlyEmail &amp;&amp; (0, _index.additionalSignUpFields)(model).map(<span class="fstat-no" title="function not covered" >function (x) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(_custom_input2.default, {</span>
        iconUrl: x.get("icon"),
        key: x.get("name"),
        model: model,
        name: x.get("name"),
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var passwordPane = !onlyEmail &amp;&amp; _react2.default.createElement(_password_pane2.default, {</span>
      i18n: i18n,
      lock: model,
