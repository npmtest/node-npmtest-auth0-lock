...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/error_screen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/error_screen.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/core/</a> &#187; error_screen.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ErrorScreen() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ErrorScreen);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, _Screen.call(this, "error"));</span>
  }
&nbsp;
  ErrorScreen.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    return ErrorPane;</span>
  };
&nbsp;
  return ErrorScreen;
}(_screen2.default);
...
&nbsp;
&nbsp;
var ErrorPane = <span class="fstat-no" title="function not covered" >function ErrorPane(_ref) {</span>
