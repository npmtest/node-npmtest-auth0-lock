...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/ui/input/input_wrap.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/ui/input/input_wrap.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/ui/input/</a> &#187; input_wrap.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InputWrap() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, InputWrap);</span>
&nbsp;
...
&nbsp;
  InputWrap.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    var _props = this.props,</span>
        ...
        icon = _props.icon;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var blockClassName = "auth0-lock-input-block auth0-lock-input-" + name;</span>
<span class="cstat-no" title="statement not covered" >    if (!isValid) {</span>
<span class="cstat-no" title="statement not covered" >      blockClassName += " auth0-lock-error";</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var wrapClassName = "auth0-lock-input-wrap";</span>
<span class="cstat-no" title="statement not covered" >    if (focused &amp;&amp; isValid) {</span>
<span class="cstat-no" title="statement not covered" >      wrapClassName += " auth0-lock-focused";</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      iconElement = _react2.default.createElement("span", { dangerouslySetInnerHTML: { __html: icon } });</span>
    } else <span class="cstat-no" title="statement not covered" >if (icon) {</span>
<span class="cstat-no" title="statement not covered" >      iconElement = icon;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (iconElement) {</span>
<span class="cstat-no" title="statement not covered" >      wrapClassName += " auth0-lock-input-wrap-with-icon";</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var errorTooltip = !isValid &amp;&amp; invalidHint ? _react2.default.createElement(</span>
      "div",
