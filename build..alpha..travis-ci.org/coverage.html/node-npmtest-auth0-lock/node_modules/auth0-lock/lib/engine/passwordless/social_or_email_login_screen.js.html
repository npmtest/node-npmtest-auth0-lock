...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/social_or_email_login_screen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/social_or_email_login_screen.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/</a> &#187; social_or_email_login_screen.js</div>
</div>
<div class="body">
...
&nbsp;
var useSocialBigButtons = <span class="fstat-no" title="function not covered" >function useSocialBigButtons(m) {</span>
<span class="cstat-no" title="statement not covered" >  var limit = l.connections(m, "passwordless", "email").count() === 0 ? 5 : 3;</span>
<span class="cstat-no" title="statement not covered" >  return (0, _index.useBigButtons)(m, limit);</span>
};
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var email = l.hasSomeConnections(model, "passwordless", "email") ? _react2.default.createElement(_email_pane2.default, {</span>
    i18n: i18n,
    lock: model,
...
<span class="cstat-no" title="statement not covered" >  var emailInstructionsI18nKey = social ? "passwordlessEmailAlternativeInstructions" : "passwordlessEmailInstructions";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var headerText = i18n.html(emailInstructionsI18nKey) || null;</span>
<span class="cstat-no" title="statement not covered" >  var header = email &amp;&amp; headerText &amp;&amp; _react2.default.createElement(</span>
    'p',
    null,
    headerText
  );
&nbsp;
<span class="cstat-no" title="statement not covered" >  var separator = social &amp;&amp; email ? _react2.default.createElement(_pane_separator2.default, null) : null;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SocialOrEmailLoginScreen() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SocialOrEmailLoginScreen);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, _Screen.call(this, "socialOrEmail"));</span>
  }
&nbsp;
  SocialOrEmailLoginScreen.prototype.submitHandler = <span class="fstat-no" title="function not covered" >function submitHandler(m) {</span>
<span class="cstat-no" title="statement not covered" >    return l.hasSomeConnections(m, "passwordless", "email") ? _actions.requestPasswordlessEmail : null;</span>
  };
&nbsp;
  SocialOrEmailLoginScreen.prototype.renderAuxiliaryPane = <span class="fstat-no" title="function not covered" >function renderAuxiliaryPane(lock) {</span>
<span class="cstat-no" title="statement not covered" >    return (0, _email_sent_confirmation.renderEmailSentConfirmation)(lock) || (0, _signed_in_confirmation.renderSignedInConfirmation)(lock);</span>
  };
&nbsp;
  SocialOrEmailLoginScreen.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
