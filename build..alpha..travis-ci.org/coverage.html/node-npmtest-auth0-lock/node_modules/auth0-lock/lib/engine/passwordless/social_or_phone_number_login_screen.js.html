...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/social_or_phone_number_login_screen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/social_or_phone_number_login_screen.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/engine/passwordless/</a> &#187; social_or_phone_number_login_screen.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var limit = l.connections(m, "passwordless", "sms").count() === 0 ? 5 : 3;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var phoneNumberInstructionsI18nKey = social ? "passwordlessSMSAlternativeInstructions" : "passwordlessSMSInstructions";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var phoneNumber = l.hasSomeConnections(model, "passwordless", "sms") ? _react2.default.createElement(_phone_number_pane2.default, {</span>
    instructions: i18n.html(phoneNumberInstructionsI18nKey),
    lock: model,
    placeholder: i18n.str("phoneNumberInputPlaceholder")
  }) : null;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var separator = social &amp;&amp; phoneNumber ? _react2.default.createElement(_pane_separator2.default, null) : null;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AskSocialNetworkOrPhoneNumber() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AskSocialNetworkOrPhoneNumber);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, _Screen.call(this, "socialOrPhoneNumber"));</span>
  }
&nbsp;
  AskSocialNetworkOrPhoneNumber.prototype.submitHandler = <span class="fstat-no" title="function not covered" >function submitHandler(m) {</span>
<span class="cstat-no" title="statement not covered" >    return l.hasSomeConnections(m, "passwordless", "sms") ? _actions.sendSMS : null;</span>
  };
&nbsp;
  AskSocialNetworkOrPhoneNumber.prototype.renderAuxiliaryPane = <span class="fstat-no" title="function not covered" >function renderAuxiliaryPane(lock) {</span>
<span class="cstat-no" title="statement not covered" >    return (0, _signed_in_confirmation.renderSignedInConfirmation)(lock) || (0, _index3.renderOptionSelection)(lock);</span>
  };
&nbsp;
  AskSocialNetworkOrPhoneNumber.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
