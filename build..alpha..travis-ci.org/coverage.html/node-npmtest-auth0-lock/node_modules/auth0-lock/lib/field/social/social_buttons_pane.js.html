...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/social/social_buttons_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/social/social_buttons_pane.js</span></h1>
    <h2>
        
        Statements: <span class="metric">50% <small>(29 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">26.53% <small>(13 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/social/</a> &#187; social_buttons_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SocialButtonsPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SocialButtonsPane);</span>
&nbsp;
...
&nbsp;
  SocialButtonsPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var headerText = instructions || null;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var themes = (0, _index2.authButtonsTheme)(lock);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var buttons = (0, _index2.socialConnections)(lock).map(<span class="fstat-no" title="function not covered" >function (x) {</span></span>
<span class="cstat-no" title="statement not covered" >      var buttonTheme = themes.get(x.get("name"));</span>
<span class="cstat-no" title="statement not covered" >      var connectionName = buttonTheme &amp;&amp; buttonTheme.get("displayName");</span>
<span class="cstat-no" title="statement not covered" >      var primaryColor = buttonTheme &amp;&amp; buttonTheme.get("primaryColor");</span>
<span class="cstat-no" title="statement not covered" >      var foregroundColor = buttonTheme &amp;&amp; buttonTheme.get("foregroundColor");</span>
<span class="cstat-no" title="statement not covered" >      var icon = buttonTheme &amp;&amp; buttonTheme.get("icon");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(_auth_button2.default, {</span>
        isBig: bigButtons,
        key: x.get("name"),
...
<span class="cstat-no" title="statement not covered" >          return (0, _actions.logIn)(l.id(lock), x);</span>
        },
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var loading = showLoading &amp;&amp; _react2.default.createElement(</span>
      'div',
