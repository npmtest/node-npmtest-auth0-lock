...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/vcode/vcode_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/vcode/vcode_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/vcode/</a> &#187; vcode_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function VcodePane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, VcodePane);</span>
&nbsp;
...
&nbsp;
  VcodePane.prototype.handleVcodeChange = <span class="fstat-no" title="function not covered" >function handleVcodeChange(e) {</span>
<span class="cstat-no" title="statement not covered" >    e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >    (0, _index3.swap)(_index3.updateEntity, "lock", l.id(this.props.lock), _vcode.setVcode, e.target.value);</span>
  };
&nbsp;
  VcodePane.prototype.handleResendClick = <span class="fstat-no" title="function not covered" >function handleResendClick(e) {</span>
<span class="cstat-no" title="statement not covered" >    e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >    var _props = this.props,</span>
        lock = _props.lock,
        onRestart = _props.onRestart;
&nbsp;
<span class="cstat-no" title="statement not covered" >    onRestart(l.id(lock));</span>
  };
&nbsp;
  VcodePane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
