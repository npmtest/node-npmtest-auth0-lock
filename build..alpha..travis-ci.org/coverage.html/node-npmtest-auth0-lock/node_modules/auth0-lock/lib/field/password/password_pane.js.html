...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/password/password_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/password/password_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/field/password/</a> &#187; password_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PasswordPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PasswordPane);</span>
&nbsp;
...
&nbsp;
  PasswordPane.prototype.handleChange = <span class="fstat-no" title="function not covered" >function handleChange(e) {</span>
<span class="cstat-no" title="statement not covered" >    var _props = this.props,</span>
        lock = _props.lock,
        policy = _props.policy;
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _index2.swap)(_index2.updateEntity, "lock", l.id(lock), _password.setPassword, e.target.value, policy);</span>
  };
&nbsp;
  PasswordPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(_password_input2.default, {</span>
