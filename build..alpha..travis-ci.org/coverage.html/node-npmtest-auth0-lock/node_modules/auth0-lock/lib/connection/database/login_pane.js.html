...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/login_pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/login_pane.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-auth0-lock/node_modules/auth0-lock/lib/connection/database/</a> &#187; login_pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function LoginPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, LoginPane);</span>
&nbsp;
...
&nbsp;
  LoginPane.prototype.handleDontRememberPasswordClick = <span class="fstat-no" title="function not covered" >function handleDontRememberPasswordClick(e) {</span>
<span class="cstat-no" title="statement not covered" >    e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >    (0, _actions.showResetPasswordActivity)(l.id(this.props.lock));</span>
  };
&nbsp;
  LoginPane.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
...
<span class="cstat-no" title="statement not covered" >    var fieldPane = usernameStyle === "email" ? _react2.default.createElement(_email_pane2.default, {</span>
      i18n: i18n,
      lock: lock,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var passwordPane = showPassword ? _react2.default.createElement(_password_pane2.default, {</span>
      i18n: i18n,
      lock: lock,
      placeholder: passwordInputPlaceholder
    }) : null;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var dontRememberPassword = showForgotPasswordLink &amp;&amp; (0, _index.hasScreen)(lock, "forgotPassword") ? _react2.default.createElement(</span>
      'p',
